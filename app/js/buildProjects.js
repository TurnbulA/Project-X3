  ...
  const projectIcons = Object.values(projects)
    .map(item => {
      ...
      return `<li class="c-projects__list--item project-Icon " data-id=${item.dataId}>
          <div class="c-projects__icon--border u-gradient-border--${item.colour}" data-id=${item.dataId}>
              <div class="c-projects__icon u-gradient-bg--${item.colour} project-Icon" data-id=${item.dataId}>
